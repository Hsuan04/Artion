...
public class MemberVO {
	...
	public MemberVO(Integer memId, String memName, String memAccount, String memPassword, String memGender,
			Date memBirthday, String memMobile, String memAddress, Date memRegisterdTime, Date memLastModifiedTime,
			Integer memLevLevel, byte[] memProfilePhoto, Integer memTotalCost) {
		super();
		this.memId = memId;
